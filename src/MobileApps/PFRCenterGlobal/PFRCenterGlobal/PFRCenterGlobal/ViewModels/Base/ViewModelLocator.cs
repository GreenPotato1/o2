...
using PFRCenterGlobal.Services.Dialog;
using PFRCenterGlobal.Services.FixUri;
using PFRCenterGlobal.Services.Identity;
using PFRCenterGlobal.Services.Navigation;
using PFRCenterGlobal.Services.OpenUrl;
using PFRCenterGlobal.Services.RequestProvider;
using PFRCenterGlobal.Services.Settings;
using PFRCenterGlobal.TinyIoC;
using Xamarin.Forms;

namespace PFRCenterGlobal.ViewModels.Base
{
