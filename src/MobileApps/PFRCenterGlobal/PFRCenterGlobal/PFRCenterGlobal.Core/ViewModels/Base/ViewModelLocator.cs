...
using PFRCenterGlobal.Core.Services.Basket;
using PFRCenterGlobal.Core.Services.Catalog;
...
using PFRCenterGlobal.Core.Services.User;
using PFRCenterGlobal.Core.TinyIoC;
using Xamarin.Forms;
