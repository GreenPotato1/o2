...
using O2.Identity.API.Extensions;
    ...
    public class ApplicationDbContextSeed
    {
        ...
        private IEnumerable<ApplicationUser> GetDefaultUser()
        {
            ...
            new ApplicationUser()
            {
                ...
                City = "Redmond",
                Country = "U.S.",
                Email = "demouser@o2bionics.com",
                Expiration = "12/20",
                Id = Guid.NewGuid().ToString(),
                LastName = "DemoLastName",
                Name = "DemoUser",
                PhoneNumber = "1234567890",
                UserName = "demouser@o2bionics.com",
                ZipCode = "98052",
                State = "WA",
                Street = "15703 NE 61st Ct",
                SecurityNumber = "535",
                NormalizedEmail = "demouser@o2bionics.com",
                NormalizedUserName = "demouser@o2bionics.com",
                SecurityStamp = Guid.NewGuid().ToString("D"),
            };
