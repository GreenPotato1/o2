...
{
    /// <summary>
    /// The class renders MVC views to a string using the standard MVC View
    /// Engine to render the view. 
    /// 
    /// 
    ...
    {
        private const string ViewCouldNotBeFound = "View could not be found";

        /// <summary>
        /// Required <see cref="ControllerContext"/>
        /// </summary>
        protected ControllerContext Context { get; set; }

        /// <summary>
        /// Initializes the ViewRenderer with a <see cref="Context"/>.
        /// </summary>
        ...
        /// </param>
        /// <param name="model">The <paramref name="model"/> to render the view with</param>
        /// <returns><see cref="String"/> of the rendered view or null on error</returns>
        ...
        /// name or as fully qualified ~/ path including extension
        /// </param>
        /// <param name="model">The <paramref name="model"/> to pass to the viewRenderer</param>
        ...
        /// <summary>
        /// Renders a partial MVC view to string. Use this method to render a
        /// partial view that doesn't merge with _Layout and doesn't fire
        /// _ViewStart.
        /// </summary>
        /// <param name="viewPath">
        /// The path to the view to render. Either in same controller, shared by
        /// name or as fully qualified ~/ path including extension
        /// </param>
        /// <param name="model">The <paramref name="model"/> to pass to the
        /// viewRenderer</param>
        /// <param name="controllerContext">Active controller context</param>
        /// <returns>String of the rendered view or null on error</returns>
        ...
        /// <summary>
        /// Internal method that handles rendering of either <paramref name="partial"/> or 
        /// or full views.
        /// </summary>
        /// <param name="viewPath">
        /// The path to the view to render. Either in same controller, shared by 
        ...
        /// <param name="partial">Determines whether to render a full or <paramref name="partial"/> view</param>
        /// <returns>String of the rendered view</returns>
        protected string RenderViewToStringInternal(
            string viewPath,
            object model,
            bool partial = false)
        {
