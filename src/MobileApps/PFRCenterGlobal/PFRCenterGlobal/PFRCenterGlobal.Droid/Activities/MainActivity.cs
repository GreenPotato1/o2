...
using PFRCenterGlobal.Droid.Services;
using Xamarin.Forms.Platform.Android;

namespace PFRCenterGlobal.Droid.Activities
{
    [Activity(
        Label = "PFRCenterGlobal",
        Icon = "@drawable/icon",
    ...
    public class MainActivity : FormsAppCompatActivity
    {
        ...
        {
            FormsAppCompatActivity.ToolbarResource = Xamarin.Forms.Platform.Android.Resource.Layout.Toolbar;
            FormsAppCompatActivity.TabLayoutResource = Xamarin.Forms.Platform.Android.Resource.Layout.Tabs;
